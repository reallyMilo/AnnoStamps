      ...
      <Layout>
        ...
        <div className="support_block page">
          <h2 className="font-bold mb-2">
            <span>Anno Stamps Privacy Policy</span>
          </h2>
          <p className="mb-2">
            <span>
            ...
            <span>https://heroplugins.com</span>
            <span>, or any of our product demo subdomains, (the “Site”).</span>
          </p>
          <h3 className="font-bold mv-2">
          ...
          <p className="mb-2">
            Additionally when you subscribe to our newsletter we collect your
          ...
          <p className="mb-2">
            <span>
              ...
              for potential risk to the Site (in particular, your IP address),
          ...
          <p className="mb-2">
            ...
            Google Analytics, to help us use your Personal Information, as
            described above. &nbsp;We use Google Analytics to help us understand
          ...
          <p className="mb-2">
            <span>
              ...
              personal information we hold about you and to ask that this
              information be corrected, updated, or deleted. If you would like
              to exercise this right, please contact us through the contact
              information below.
            </span>
          </p>
          <p className="mb-2">
            <span>
              ...
              processing your information in order to pursue our legitimate
              business interests listed above. Additionally, please note that
              your information will be transferred outside of Europe, including
          ...
          <p className="mb-2">
            <span>
              When you subscribe to our newsletter through the Site, we will
          ...
          <p className="mb-2">
            <span>
              ...
              questions, would like to update or remove your personal
              information, or if you would like to make a complaint, please
              contact us by e-mail at annostampsite@gmail.com.&nbsp;
            </span>
          </p>
          <div className="page" title="Page 1">
            <div className="section">
              <div className="layoutArea"></div>
            </div>
          </div>
          <p>&nbsp;</p>
        </div>
