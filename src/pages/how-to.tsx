...
const HowTo = () => {
  return (
    <Container className="max-w-5xl">
      ...
      />
      <p className="py-5">
        Stamps are grouped in folders. Clicking on the stamp folder in the stamp
        menu will display a menu above it with a list of stamps in that folder.
        Right clicking the stamp or the stamp folder will display a menu
      ...
      <p className="pb-5">
        Stamps are organized by the region they are associated with so you will
        need to place the stamp file in the relevant region folder. Stamps can
        also be further sub categorized inside the region folder with a folder
