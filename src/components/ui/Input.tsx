      ...
      >
        <Headless.Input
          ...
          className={cn([
            ...
            // Typography
            'text-base/6 text-midnight placeholder:text-zinc-500 sm:text-sm/6 dark:text-white',
            // Border
            ...
            // Disabled state
            'data-[disabled]:border-midnight/20 dark:data-[hover]:data-[disabled]:border-white/15 data-[disabled]:dark:border-white/15 data-[disabled]:dark:bg-white/[2.5%]',
          ])}
        />
      </span>
    )
